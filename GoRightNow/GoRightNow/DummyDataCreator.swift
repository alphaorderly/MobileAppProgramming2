...
func demoGetCountryInfo() -> GoRightNowModel.Country {
    let name = "아이슬란드"
    ...
    let demoData = GoRightNowModel.Country(name: name, immigInfo: immigInfo, immigInfoForKor: immigInfoForKor)
    return demoData
}

func demoGetCountryInfoNoKor() -> GoRightNowModel.Country {
    let name = "일본"
    ...
    let demoData = GoRightNowModel.Country(name: name, immigInfo: immigInfo, immigInfoForKor: "none")
    return demoData
}
